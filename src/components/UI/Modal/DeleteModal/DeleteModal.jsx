...
const DeleteModal = ({ open, handleClose, onRemoveTask }) => (
  <div>
    <Dialog open={open.status} onClose={handleClose} aria-labelledby='draggable-dialog-title'>
      <DialogTitle id='draggable-dialog-title'>Delete task</DialogTitle>

      <DialogContent>
        <DialogContentText>do you want to delete this task?</DialogContentText>
      </DialogContent>
